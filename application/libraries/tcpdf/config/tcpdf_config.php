 ...
 */
define ('PDF_HEADER_LOGO', 'ristekdikti.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Laporan Hasil Seleksi');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Bidikmisi - www.bidikmisi.belmawa.ristekdikti.go.id");
